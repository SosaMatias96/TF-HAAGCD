...
fixed_time = 020.00   # Un instante de tiempo específico dentro de tu rango de datos
...
contourf_plot = plt.contourf(X_grid, Y_grid, predicted_temperatures_grid, levels=20, cmap='viridis') # 'levels' controla el número de isolíneas/colores
